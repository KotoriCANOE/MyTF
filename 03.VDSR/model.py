...
tf.app.flags.DEFINE_integer('g_depth', 18,
...
tf.app.flags.DEFINE_float('batch_norm', 0,
...
tf.app.flags.DEFINE_float('gradient_clipping', 1e-3,
    ...
    def generator(self, images_lr, is_training=False, reuse=None):
        ...
        with tf.variable_scope('generator', reuse=reuse) as scope:
            ...
            with tf.variable_scope('resize_conv{}'.format(l)) as scope:
                last = layers.resize_conv2d(last, ksize=self.k_last, out_channels=self.image_channels,
