...
#plot1(['158.1', 162], ['Adam', 'Nadam'], '162')
#plot1([164, 162, 163, 165, 168], ['decay_step=250', 'decay_step=500', 'decay_step=1000', 'polynomial8', 'custom1'], '164')
#plot1([165, 166, 167], ['epsilon=1e-8', 'epsilon=1e-3', 'epsilon=1e-1'], '165')
plot1([162, 169, 170], ['random_resizer+noise+JPEG', 'random_resizer', 'spline16'], '169')
