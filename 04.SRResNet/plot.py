...
plot1(['162.1', 176, 180, 181], ['Nadam train_ema=0', 'Nadam train_ema=0.9999', 'adaptive decay 1, 0.50', 'adaptive decay 2, 0.50'], '180')
plot1(['162.1', 176, 181, 182, 183], ['Nadam train_ema=0', 'Nadam train_ema=0.9999', 'adaptive decay 2, 0.50', 'adaptive decay 2, 0.29', 'adaptive decay 2, 0.16'], '181')
